...
import { InstallmentsPage, InstallmentsListSkeleton } from '@/components/page/installments';
import { useUserLoans } from '@/queries/installments';
...
function InstallmentsContent() {
      ...
      <div className='w-full pt-10'>
        <div className='bg-white rounded-xl shadow-md p-12 text-center'>
          <div className='flex flex-col items-center gap-4'>
            ...
            <p className='text-gray-500 text-sm'>برای مشاهده اقساط خود ابتدا وارد شوید</p>
          </div>
        </div>
      </div>
    );
  ...
  return <InstallmentsPage loans={loans || []} isLoading={isLoading} />;
}
...
export default function InstallmentsPageRoute() {
  ...
  return (
    <PageContainer breadcrumbs={breadcrumbs}>
      <PageContent title='اقساط من'>
        <Suspense fallback={<InstallmentsListSkeleton />}>
          <InstallmentsContent />
        </Suspense>
      </PageContent>
    </PageContainer>
