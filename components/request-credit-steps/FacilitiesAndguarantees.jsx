  ...
  const renderOptionalFields = () => {
    return optionalFiles.map((file, index) => (
      <div key={index} className="mt-4">
        <input type="file" accept="image/png, image/jpeg" className="border border-gray-300 rounded p-2 w-full" onChange={(e) => handleOptionalUpload(e, index)} />
        {uploadProgress[`optional_${index + 1}`] && (
          <div className="mt-2">
            ...
            {uploadProgress[`optional_${index + 1}`] === "success" && <p className="text-green-500">با موفقیت آپلود شد !</p>}
            {uploadProgress[`optional_${index + 1}`] === "error" && <p className="text-red-500">مشکلی پیش آمد مجددا تلاش کنید.</p>}
          </div>
        )}
      </div>
    ));
        ...
        <div className="w-full flex flex-col items-start justify-start">
          ...
          <div className="w-full flex flex-col items-start justify-start gap-10">
            <div className="w-full flex justify-center">
              <div className={`rounded-2xl w-full sm:w-3/4 lg:ml-20 lg:p-8 lg:pt-6 p-3 border-2 ${"border-green-600 bg-green-100"}`}>
                ...
                <div className="font-bold flex flex-col gap-5 mx-16">
                  <span className="md:grid grid-cols-2 border-b border-b-black/20 pb-3">
                    ...
                    <p className="w-full py-4 text-start md:text-center text-black/60">{"دارای چک برگشتی"}</p>
                  </span>
                  <span className="md:grid grid-cols-2 border-b border-b-black/20 pb-3">
            ...
            <div className="w-full flex justify-center">
              <div className={`rounded-2xl w-full sm:w-3/4 lg:ml-20 lg:p-8 lg:pt-6 p-3 border-2 ${"border-gray-600 bg-gray-100"}`}>
                <p className="font-bold text-xl mb-8">تضامین بانکی</p>
                <div className="font-bold flex flex-col gap-5 mx-16">
                  <span className="md:grid grid-cols-2 border-b border-b-black/20 pb-3">
                    <h3 className="whitespace-nowrap py-4">مقدار ضمانت :</h3>
                    <p className="w-full py-4 text-start md:text-center text-black/60">{PriceDisplayWithOutLabel("1000000000")} ریال</p>
                  </span>
                  <span className="md:grid grid-cols-2">
                    <h3 className="whitespace-nowrap py-4">معوق ؟ </h3>
