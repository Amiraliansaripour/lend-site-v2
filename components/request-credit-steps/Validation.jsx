...
const Validation = ({ onNext, user, requestId, isEditMode, neededScore }) => {
  ...
  return (
    <div className='relative main-validation-content'>
      {showOtpModal && (
        <OtpVerificationModal5Digit
          isOpen={showOtpModal}
          onClose={() => setShowOtpModal(false)}
          onConfirm={verifyOtpApi}
          ...
          <div className='w-full bg-white rounded-2xl gap-4 p-4'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 w-full gap-8'>
              {isVerifyingOtp ? (
                ...
                <>
                  <div
                    className={`rounded-2xl font-bold p-3 border-2 ${requestData?.score >= neededScore ? 'border-green-600/50 bg-green-100/50' : 'border-red-600/50 bg-red-100/50'}`}
                  >
                    <div className='grid grid-cols-2 place-items-center h-10'>
