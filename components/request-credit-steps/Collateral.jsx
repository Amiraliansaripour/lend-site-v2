  ...
  const loginUser = async () => {
    ...
    try {
      const response = await axiosInstance.post(
        `${import.meta.env.VITE_BASE_API}/api/v1/Pledge/GetPortfoOtp`,
        formData,
        {
          headers: {
            ...headers,
    ...
    <div>
        ...
        <div className='text-right shadow-lg p-6 rounded-lg border-2 bg-white'>
          ...
          <div className='flex flex-col md:flex-row justify-center items-center gap-6'>
            <button
              ...
              className='flex flex-col items-center justify-center p-8 border-2 border-transparent hover:border-gold-primary-900 transition-all ease-in rounded-lg shadow-md w-full md:w-1/2 bg-gradient-to-br from-green-50 to-green-100 text-center cursor-pointer group'
            >
              <svg
                ...
                strokeWidth={1.5}
                stroke='currentColor'
                className='w-10 h-10 text-gold-primary-900 mb-4 group-hover:scale-110 transition-transform ease-in-out'
              >
                <path
                  strokeLinecap='round'
              ...
              <span className='text-xl font-bold text-gray-800 mb-2 group-hover:text-gold-primary-800 transition-colors ease-in-out'>
                بارگذاری وثیقه
              </span>
      ...
      {selectedMethod === 'check' && (
        <ChequeRegistration
          ...
          name='فناوری اطلاعات راژمان'
          shenase='14014520172'
          price='1,000,000'
          yektaID='1234567890123456'
        />
      )}
