        ...
        <div className='text-lg w-full font-semibold border-b text-right border-r-4 border-green-400 bg-green-50 shadow-lg rounded-md rounded-b-none p-6 max-w-sm mx-auto'>
          ...
          <div className='space-y-4'>
            <div className='flex justify-between items-center text-gray-700'>
              <span className='flex items-start text-gray-700 text-sm text-right'>
                اعتبار سنجی:
              </span>
              <span className='flex items-start text-gray-700 text-sm font-bold text-right'>
                {PriceDisplayWithOutLabel(validationPrice)} ریال
              </span>
            </div>
          </div>
        </div>
        ...
        <div className='bg-white w-full max-w-sm border-r-4 border-green-400 p-4 shadow-sm rounded-md rounded-t-none'>
          ...
          <div className='mb-4'>
            ...
            <input
              ...
              type='text'
              id='mobile'
              className='mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none text-gray-400 sm:text-sm text-right'
          ...
          <div className='mb-6'>
            ...
            <input
              ...
              id='national-code'
              className='mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none text-gray-400 sm:text-sm text-right'
              value={user?.personInfo?.nationalCode || ''}
              disabled
            />
          </div>
          {/* بخش نمایش مبلغ */}
          <div className='mt-6 mb-6 text-center text-gray-700'>
            ...
            <span className='inline-flex items-baseline'>
              <span className='text-3xl font-bold text-green-600 ml-1'>
                {PriceDisplayWithOutLabel(validationPrice)}{' '}
              </span>
          ...
          <button
            ...
            className={`w-full flex justify-center items-center gap-2 py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-green-500 hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition duration-200 ease-in-out${isPaymentButtonDisabled && 'opacity-50 cursor-not-allowed'}`}
