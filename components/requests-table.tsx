    ...
    () => [
      {
        ...
        meta: { label: 'تاریخ درخواست', variant: 'text' },
      ...
      },
      {
        id: 'period',
        accessorKey: 'period',
        meta: { label: 'مدت بازپرداخت', variant: 'text' },
        header: ({ column }: { column: Column<any, unknown> }) => (
      ...
      },
      {
        ...
        meta: { label: 'شناسه درخواست', variant: 'text' },
        header: ({ column }: { column: Column<any, unknown> }) => (
