      ...
      <DialogContent className=''>
        {view === 'main' ? (
          <>
            ...
            <ScrollArea className='max-h-[60vh]  px-2' dir='rtl'>
              <div className='flex flex-col gap-4 pr-2'>
                ...
                <div className={boxClass}>
                  به دلیل کارمزدهای مربوط به تشکیل پرونده و فرآیندهای ارزیابی، مبلغ نهایی خرید نقدی
                  و اقساطی متفاوت خواهد بود.
                </div>
                <div className={boxClass}>
          ...
          <>
            ...
            <DialogFooter className='flex gap-3 justify-end'>
              <Button variant='outline' onClick={() => setView('main')} className='rounded'>
                بازگشت
              </Button>
              <Button
