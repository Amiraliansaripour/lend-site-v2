...
export function LandingHero() {
  ...
  return (
    <section className='relative overflow-hidden'>
      <div
        aria-hidden
        className='pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_at_top,#dbeafe_0%,#eff6ff_45%,transparent_70%)]'
      />

      <div className='container relative flex flex-col items-center pt-28 pb-16 text-center md:pt-36 md:pb-24 lg:pt-40 lg:pb-28'>
        <h1 className='max-w-3xl text-3xl font-extrabold leading-tight text-[#0f172a] md:text-4xl lg:text-5xl'>
          اعتباری که می‌شود به آن <span className='text-brand'>اعتماد</span>
        ...
        <div className='mt-8 flex items-center justify-center gap-3'>
          ...
          <Link
            href='/help'
            className='inline-flex h-12 items-center justify-center rounded-full bg-white/80 border border-gray-200 px-6 text-sm font-medium text-slate-700 transition-colors hover:bg-white'
          >
            مراحل دریافت اعتبار
          </Link>
        </div>
