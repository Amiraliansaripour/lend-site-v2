  ...
  return (
    <>
      <div className='grid w-full grid-cols-1 place-items-center gap-4 sm:grid-cols-2 sm:gap-6 xl:grid-cols-3'>
        <WalletCard>
          <WalletCard.Front style={cardGradientStyle} className='border-0 p-5 text-white'>
            <CardCircles />

            <div className='z-10 flex w-full items-start justify-start' dir='ltr'>
