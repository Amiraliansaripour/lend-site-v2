...
ARG NEXT_PUBLIC_API_REPORT_URL=https://lendreporttest.persiansys.ir/api/v1
ARG NEXT_PUBLIC_AUTH_API_URL=
ARG NEXT_PUBLIC_TCI_LENDTECH_SECRET=
ARG NEXT_PUBLIC_QUERY_GC_TIME=0
ARG NEXT_PUBLIC_QUERY_STALE_TIME=0
ARG NEXT_PUBLIC_QUERY_RETRY=1

ENV NEXT_PUBLIC_API_BASE_URL=$NEXT_PUBLIC_API_BASE_URL \
    NEXT_PUBLIC_API_REPORT_URL=$NEXT_PUBLIC_API_REPORT_URL \
    NEXT_PUBLIC_AUTH_API_URL=$NEXT_PUBLIC_AUTH_API_URL \
    NEXT_PUBLIC_TCI_LENDTECH_SECRET=$NEXT_PUBLIC_TCI_LENDTECH_SECRET \
